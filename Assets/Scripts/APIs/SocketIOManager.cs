...
public class SocketIOManager : MonoBehaviour
{
  ...
  // Driven ONLY by the WebGL/JS focus bridge (UIManager.OnFocusChanged). Deliberately not wired
  // to OnApplicationFocus — that signal isn't trustworthy inside a WebView, and a spurious one
  // would close a live session.
...
// {
//   public bool isBonusTriggered;
//   public List<List<int>> bonusPositions;
//   public int? wheelIndex;
//   public float bonuseWinAmount;
// }
// [Serializable]
// public class Win
// {
...
public class SpecialWins
{
  public AnyBar anyBar { get; set; }
  public Cherry cherry { get; set; }
  public WildCherry wildCherry { get; set; }
}
...
public class WheelBonus
{
  ...
  public int triggerReel { get; set; }
  public int triggerSymbolId { get; set; }
  public string triggerSymbolName { get; set; }
...
public class Win
{
  ...
  public List<List<int>> cherryPositions { get; set; }
  public bool usedWild { get; set; }
  public bool isCompleteWildLine { get; set; }
  public bool isCherryLine { get; set; }
}

public class BonusResult
{
  public bool isBonusTriggered { get; set; }
  public List<List<int>> bonusPositions { get; set; }
  public int? wheelIndex { get; set; }
  public double bonuseWinAmount { get; set; }
}
...
public class Payload
{
  public double winAmount { get; set; }
  public List<Win> wins { get; set; }
  public BonusResult bonusResult { get; set; }
...
{
  public int any1Wild { get; set; }
  public int any3Bars { get; set; }
  public int any2Wilds { get; set; }
  public int any3Sevens { get; set; }
}
...
public class Jackpot
{
  ...
  public int subJackpotPayout { get; set; }
  public int topJackpotPayout { get; set; }
  public List<int> subJackpotCombination { get; set; }
  public List<int> topJackpotCombination { get; set; }
}



public class RespinBonus
{
  public bool enabled { get; set; }
  ...
  public int respinRemaining { get; set; }
  public List<Step> steps { get; set; }
  public double totalRespinWin { get; set; }
...
public class LineWin
{
  ...
  public List<MatchedPosition> matchedPositions { get; set; }
  public List<int> symbolIds { get; set; }
  public bool isSubSymbolWin { get; set; }
  public int basePayout { get; set; }
  public int appliedMultiplier { get; set; }
  public int winInCredits { get; set; }
