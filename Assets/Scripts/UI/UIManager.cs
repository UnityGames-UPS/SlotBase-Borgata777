...
public class UIManager : MonoBehaviour
{
  ...
  [SerializeField] private CoinFountainPool coins;
  [SerializeField]
  ...
  private void Awake()
  {
    if (jsFunctCalls == null && socketManager != null) jsFunctCalls = socketManager.JSManager;
  ...
  internal void PopulateWin(int value, double amount)
  {
    ...
    switch (value)
    {
      ...
      case 2: selectedSprites = BigWin_Sprite; break;
      case 3: selectedSprites = BigWin_Sprite; break;
    }
